...
$(document).ready(function(){
        ...
        $('.user-pass-eye').click(function(){
            ...
            if(text != '') {
                ...
                if(img == '../../static/mobile/user/images/user-eye.png'){
                    $('.user-password',_form).attr('type','text');
                    $('.user-pass-eye',_form).attr('src','../../static/mobile/user/images/user-blk-eye.png');
                } else {

                    $('.user-password',_form).attr('type','password');
                    $('.user-pass-eye',_form).attr('src','../../static/mobile/user/images/user-eye.png');
                }
            }
            //debugger;
        });
